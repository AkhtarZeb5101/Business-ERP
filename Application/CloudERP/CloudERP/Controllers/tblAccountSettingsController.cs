...
namespace CloudERP.Controllers
{
    public class tblAccountSettingsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var tblAccountSettings = db.tblAccountSettings.Include(t => t.tblAccountActivity).
                Include(t => t.tblAccountControl).Include(t => t.tblAccountHead).Include(t => t.tblBranch).Include(t => t.tblCompany).
