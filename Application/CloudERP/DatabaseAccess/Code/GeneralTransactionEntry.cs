...
namespace DatabaseAccess.Code
{
    public class GeneralTransactionEntry
    {
        ...
        public string ConfirmGeneralTransaction(  
            float TransferAmount,// Parameters
            int UserID,// Parameters
            int BranchID,// Parameters
            int CompanyID,// Parameters
            string InvoiceNo,// Parameters
            int DebitAccountControlID,// Parameters
            int CreditAccountControlID,// Parameters
            ...
            )
        {
            ...
            try
            {
                ...
                AccountControlID = Convert.ToString(account.AccountControlID);
                AccountSubControlID = Convert.ToString(account.AccountSubControlID);
                transectiontitle = "General Transection Succesed.";
                ...
                return "General Tansactions Succeed.";
            }
            catch (Exception ex)
            {
